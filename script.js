    ...
    browser: {
        ...
        platforms: [
            { 
                ...
                desc: "Выберите версию",
                versions: [
                    { name: "v1.2 (стабильная)", url: "https://github.com/devovv/FusionTools-Browser-Android/releases/download/FusionToolsBrowserAndroid1.2/FusionToolsBrowser.apk" },
...
function consoleGreeting() {
    ...
    console.log('%c🌐 FusionTools Browser: Android v1.2 (стабильная), v1.1, v1.0 | Windows в разработке', 'color: #ff6b9d; font-size: 12px;');
}
