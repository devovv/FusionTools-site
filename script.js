...
const latestVersions = {
    ...
    browser: {
        ...
        url: "https://github.com/devovv/FusionTools-Browser-Android/releases/download/FusionToolsBrowserAndroid2.5/FusionToolsBrowser.apk"
    }
};
...
function consoleGreeting() {
    ...
    console.log('%c🌐 FusionTools Browser: последняя версия v2.5', 'color: #ff6b9d; font-size: 12px;');
}
