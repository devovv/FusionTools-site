    ...
    browser: {
        ...
        platforms: [
            { 
                ...
                desc: "Выберите версию",
                versions: [
                    { name: "v1.0 (стабильная)", url: "https://github.com/devovv/FusionTools-Browser-Android/releases/download/FusionToolsBrowserAndroid1.0/FusionToolsBrowser.apk" }
                ]
            },
            { 
                icon: "🪟", 
...
function consoleGreeting() {
    ...
    console.log('%c🌐 FusionTools Browser: Android готов, Windows в разработке', 'color: #ff6b9d; font-size: 12px;');
}
