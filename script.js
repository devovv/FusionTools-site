    ...
    store: {
        ...
        platforms: [
            { 
                ...
                versions: [
                    { name: "v1.7 (стабильная)", url: "https://github.com/devovv/FusionTools-Store/releases/download/FusionToolsStore1.7/FusionToolsStoreInstaller.exe" },
                    { name: "v1.6", url: "https://github.com/devovv/FusionTools-Store/releases/download/FusionToolsStore1.6/FusionToolsStoreInstaller.exe" },
    ...
    browser: {
        ...
        platforms: [
            { 
                ...
                desc: "Выберите версию",
                versions: [
                    { name: "v2.0 (стабильная)", url: "https://github.com/devovv/FusionTools-Browser-Android/releases/download/FusionToolsBrowserAndroid2.0/FusionToolsBrowser.apk" },
                    { name: "v1.9.2", url: "https://github.com/devovv/FusionTools-Browser-Android/releases/download/FusionToolsBrowserAndroid1.9.2/FusionToolsBrowser.apk" },
                    { name: "v1.9.1", url: "https://github.com/devovv/FusionTools-Browser-Android/releases/download/FusionToolsBrowserAndroid1.9.1/FusionToolsBrowser.apk" },
                    { name: "v1.9", url: "https://github.com/devovv/FusionTools-Browser-Android/releases/download/FusionToolsBrowserAndroid1.9/FusionToolsBrowser.apk" },
                    { name: "v1.8", url: "https://github.com/devovv/FusionTools-Browser-Android/releases/download/FusionToolsBrowserAndroid1.8/FusionToolsBrowser.apk" },
                    { name: "v1.7", url: "https://github.com/devovv/FusionTools-Browser-Android/releases/download/FusionToolsBrowserAndroid1.7/FusionToolsBrowser.apk" },
                    { name: "v1.6.1", url: "https://github.com/devovv/FusionTools-Browser-Android/releases/download/FusionToolsBrowserAndroid1.6.1/FusionToolsBrowser.apk" },
                    { name: "v1.6", url: "https://github.com/devovv/FusionTools-Browser-Android/releases/download/FusionToolsBrowserAndroid1.6/FusionToolsBrowser.apk" },
                    { name: "v1.5", url: "https://github.com/devovv/FusionTools-Browser-Android/releases/download/FusionToolsBrowserAndroid1.5/FusionToolsBrowser.apk" },
                    { name: "v1.4", url: "https://github.com/devovv/FusionTools-Browser-Android/releases/download/FusionToolsBrowserAndroid1.4/FusionToolsBrowser.apk" },
                    { name: "v1.3.1", url: "https://github.com/devovv/FusionTools-Browser-Android/releases/download/FusionToolsBrowserAndroid1.3.1/FusionToolsBrowser.apk" },
                    { name: "v1.3", url: "https://github.com/devovv/FusionTools-Browser-Android/releases/download/FusionToolsBrowserAndroid1.3/FusionToolsBrowser.apk" },
                    { name: "v1.2", url: "https://github.com/devovv/FusionTools-Browser-Android/releases/download/FusionToolsBrowserAndroid1.2/FusionToolsBrowser.apk" },
                    { name: "v1.1", url: "https://github.com/devovv/FusionTools-Browser-Android/releases/download/FusionToolsBrowserAndroid1.1/FusionToolsBrowser.apk" },
...
function consoleGreeting() {
    ...
    console.log('%c📦 FusionTools Store: 8 версий (v1.0–v1.7)', 'color: #ff6b9d; font-size: 12px;');
    console.log('%c🌍 FusionTools Translate: 2 версии', 'color: #ff6b9d; font-size: 12px;');
    console.log('%c🌐 FusionTools Browser: Android v1.6.1 (стабильная), v1.6, v1.5, v1.4, v1.3.1, v1.3, v1.2, v1.1, v1.0 | Windows в разработке', 'color: #ff6b9d; font-size: 12px;');
}
