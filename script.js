    ...
    browser: {
        ...
        platforms: [
            { 
                ...
                desc: "Выберите версию",
                versions: [
                    { name: "v1.6 (стабильная)", url: "https://github.com/devovv/FusionTools-Browser-Android/releases/download/FusionToolsBrowserAndroid1.6/FusionToolsBrowser.apk" },
...
function consoleGreeting() {
    ...
    console.log('%c🌐 FusionTools Browser: Android v1.6 (стабильная), v1.5, v1.4, v1.3.1, v1.3, v1.2, v1.1, v1.0 | Windows в разработке', 'color: #ff6b9d; font-size: 12px;');
}
